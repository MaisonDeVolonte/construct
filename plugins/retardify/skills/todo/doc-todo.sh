#!/bin/bash
# ========================================================
# @file doc-todo.sh - opportunity report validator sidecar
# ========================================================
# @description
# PAIR
# - sidecar for `doc-todo` — asserts a report archive matches the shape its SKILL.md documents
...
# - written by `/retardify:todo` only, so one file holds many reports
...
# @see AGENTS.md, plugins/retardify/skills/todo/SKILL.md, plugins/retardify/skills/todo/todo.sh, docs/insights/, plugins/retardify/shared/secrets.sh
