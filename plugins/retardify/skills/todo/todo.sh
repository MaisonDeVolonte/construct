#!/bin/bash
# ========================================
# @file todo.sh - opportunity-scan sidecar
# ========================================
# @description
# PAIR
# - sidecar for `/retardify:todo` — deterministic checks for broken references and code markers
...
# - it then appends that report to `docs/insights/YYYY-MM-DD.md`, in the `doc-todo` shape
# - the sidecar names today's insights path and report count, and never creates the file itself
# @see AGENTS.md, plugins/retardify/skills/todo/SKILL.md, plugins/retardify/skills/log/SKILL.md, docs/insights/, docs/logs/
