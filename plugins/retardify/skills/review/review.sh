#!/bin/bash
# ==========================================================
# @file review.sh - adversarial doc-vs-reality audit sidecar
# ==========================================================
# @description
# PAIR
# - sidecar for `/retardify:review` — gathers the telemetry the adversarial scorecard is graded against
...
# @see AGENTS.md, plugins/retardify/skills/review/SKILL.md, plugins/retardify/skills/review/SKILL.md, README.md, docs/honest/, tools/check-skills/README.md
