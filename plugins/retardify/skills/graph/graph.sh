#!/bin/bash
# ===============================================
# @file graph.sh - fan-out spec preflight sidecar
# ===============================================
# @description
# PAIR
# - sidecar for `/retardify:graph` — computes where the spec lands, then refuses to name an existing one
...
# @see AGENTS.md, plugins/retardify/skills/graph/SKILL.md, plugins/retardify/skills/graph/SKILL.md, plugins/retardify/skills/graph/doc-graphs.sh, docs/graphs/
...
VALIDATOR="plugins/retardify/skills/graph/doc-graphs.sh"
TODAY=$(date +%Y-%m-%d)
