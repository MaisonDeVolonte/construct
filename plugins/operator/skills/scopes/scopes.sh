...
# @see AGENTS.md, plugins/operator/skills/scopes/SKILL.md, plugins/operator/hooks/pretooluse.sh, plugins/operator/shared/corpus.tsv, plugins/operator/settings/settings.user.md, plugins/operator/skills/settings/SKILL.md
...
TODAYS_AUDIT="audits/scopes/$(date +%Y-%m-%d).md"
