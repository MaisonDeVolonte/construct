...
# @see AGENTS.md, plugins/operator/skills/settings/SKILL.md, plugins/operator/skills/permissions/permissions.sh, plugins/operator/skills/scopes/scopes.sh, plugins/operator/skills/settings/doc-audits.sh, audits/
...
TODAYS_AUDIT="audits/settings/$(date +%Y-%m-%d).md"
