#!/bin/bash
# ========================================================
# @file credentials.sh - credential masking prober sidecar
# ========================================================
# @description
# PAIR
# - sidecar for `/operator:credentials` — proves every credential is masked, unset, or unruled
...
# TRIGGER
# - the doc writes one dated report to `audits/credentials/`, in the `doc-credentials` shape
...
# @see AGENTS.md, plugins/operator/skills/credentials/SKILL.md, plugins/operator/skills/credentials/SKILL.md, plugins/operator/shared/secrets.sh, audits/credentials/, tools/check-skills/README.md
