 ...
 * @see plugins/operator/settings/settings.project.json, plugins/operator/settings/settings.user.md, plugins/operator/settings/settings.local.md, plugins/operator/skills/settings/settings.sh, AGENTS.md
 */
```
