...
# @see AGENTS.md, plugins/gitgud/skills/nuke/SKILL.md, plugins/gitgud/shared/triage.sh, plugins/gitgud/skills/backup/SKILL.md, plugins/gitgud/shared/handover.sh, tools/check-skills/README.md
