...
# @see AGENTS.md, plugins/gitgud/skills/continue/SKILL.md, plugins/gitgud/skills/nuke/SKILL.md, plugins/gitgud/shared/handover.sh, tools/check-skills/README.md
