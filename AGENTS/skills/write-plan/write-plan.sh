#!/bin/bash
# ===================================================
# @file write-plan.sh - staged plan preflight sidecar
# ===================================================
# @description
# PAIR
# - sidecar for `/write-plan` — computes where the plan lands, then refuses to name an existing one
...
# @see AGENTS.md, AGENTS/skills/write-plan/SKILL.md, AGENTS/skills/doc-plans/SKILL.md, AGENTS/skills/doc-plans/doc-plans.sh, docs/plans/
...
VALIDATOR="AGENTS/skills/doc-plans/doc-plans.sh"
TODAY=$(date +%Y-%m-%d)
