#!/bin/bash
# ====================================================
# @file write-guide.sh - build guide preflight sidecar
# ====================================================
# @description
# PAIR
# - sidecar for `/write-guide` — computes where the guide lands, and says if one already covers it
...
# @see AGENTS.md, AGENTS/skills/write-guide/SKILL.md, AGENTS/skills/doc-guides/SKILL.md, AGENTS/skills/doc-guides/doc-guides.sh, docs/guides/
...
VALIDATOR="AGENTS/skills/doc-guides/doc-guides.sh"
